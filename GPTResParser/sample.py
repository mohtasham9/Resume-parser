...
if __name__ == "__main__":
    ...
    resume_files = [f for f in os.listdir(resources_folder) if f.endswith(".pdf") or f.endswith(".docx")]

    for resume_file in resume_files:
        resume_path = os.path.join(resources_folder, resume_file)
